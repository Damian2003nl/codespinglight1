...
// Copy this exact array from your gallery template
$products = array(
    'aruba' => array(
        'name' => 'Aruba',
        'image' => get_template_directory_uri() . '/assets/images/aruba.png',
        'type' => 'vloerlamp',
        'materiaal' => array('metaal'),
        'kleur' => array('zwart'),
    ),
$products = array(
    'aruba' => array(
...
if ($product): ?>
    <div style="max-width: 1200px; margin: 0 auto; padding: 20px;">
        <a href="<?php echo home_url('/products-gallery/'); ?>" style="color: #BE924A; text-decoration: none; display: block; margin-bottom: 20px;">
        ...
        <div style="display: flex; gap: 40px;">
            ...
            <div style="flex: 1;">
                ...
                <div style="margin-top: 20px;">
                    ...
                    <p><strong>Materiaal:</strong> <?php echo implode(', ', $product['materiaal']); ?></p>
                    <p><strong>Kleur:</strong> <?php echo implode(', ', $product['kleur']); ?></p>
                </div>
            </div>
        </div>
    </div>
<?php else: ?>
    <div style="text-align: center; padding: 50px;">
        ...
        <a href="<?php echo home_url('/products-gallery/'); ?>" style="color: #BE924A;">Terug naar producten</a>
    </div>
<?php endif;
